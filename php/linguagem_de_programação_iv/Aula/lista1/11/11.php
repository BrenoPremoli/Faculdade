...
{ 
    ...
    if (is_numeric($n) && ($n > 0))
    {
        if ($n > 4)
        {
            ...
            if (($n >= 5) && ($n <= 7))
            {
                $msg = "Classificação: INFANTIL A";
            }
            elseif (($n >= 8) && ($n <= 11))
            {
                $msg = "Classificação: INFANTIL B";
            }
            elseif (($n >= 12) && ($n <= 13))
            {
                $msg = "Classificação: JUVENIL A";
            }
            elseif (($n >= 14) && ($n <= 17))
            {
                $msg = "Classificação: JUVENIL B";
            }
            else
            {
...
<div class = "all">
  <header>
    <div class="p-4 mb-4 bg-primary">
      ...
      <hr class="my-3">
      <p class="lead">Dada a idade de um nadador classifique-o em uma das seguintes categorias:<br>- Infantil A = 5 a 7 anos<br>- Infantil B = 8 a 11 anos<br>- Juvenil A = 12 a 13 anos<br>- Juvenil B = 14 a 17 anos<br>- Adultos = Maiores de 18 anos</p>
    </div>
  </header>
  ...
  <div class="container">
    <form method="GET">
      <div class="form-group col-md-2">
        <label for="n">Digite a idade:</label>
      ...
      <a href="11.php"><button type="button" class="btn btn-primary mb-2" name="limpar">Limpar</button></a>
