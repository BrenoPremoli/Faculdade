...
{ 
    ...
    if (is_numeric($n))
    {
      $flag_msg = true;
      if ($n > 0)
      $msg = "O valor é POSITIVO";
      elseif ($n == 0)
      $msg = "O valor é IGUAL a 0";
      else
      $msg = "O valor é NEGATIVO";
    }
    else
    {
      $flag_msg = false;
...
<div class = "all">
  <header>
    <div class="p-4 mb-4 bg-primary">
      <h1 class="display-5">Negativo/Positivo/Igual a zero</h1>
      <hr class="my-3">
      <p class="lead">Desenvolva um programa que receba um valor digitado pelo usuário e verifique se esse valor é positivo, negativo ou igual a zero. Imprima na tela: "Valor Positivo", "Valor Negativo", "Igual a Zero".</p>
    </div>
  </header>
  ...
  <div class="container">
    <form method="GET">
      ...
      <a href="4.php"><button type="button" class="btn btn-primary mb-2" name="limpar">Limpar</button></a>
